...
Идентификация объектов в слоях Веб ГИС
---------------------------------------

NextGIS Connect позволяет получать информацию об объектах слоёв, хранящихся на сервере NextGIS Web, их вложениях и описаниях. Выберите инструмент |button_c_identify| в панели NextGIS Connect или на панели инструментов NextGIS Connect. Кликните по объекту на карте, откроется панель идентификации с тремя вкладками:

* Атрибуты;
* Вложения;
* Описание.

.. figure:: _static/ngc_identify_feature_ru.png
   :name: ngc_identify_feature_pic
   :align: center
   :width: 20cm

   Идентификация объекта слоя Веб ГИС

На вкладке "Описание" вы можете посмотреть описание объекта, включая форматирование и изображения, добавленные в него.
...
На вкладке "Вложения" можно просматривать файлы, добавленные к объекту. Исходно загружаются только превью вложений, если вы хотите скачать файл целиком, откройте контекстное меню вложения и нажмите **Загрузить**.

Через контекстное меню вложения вы можете:

* Загрузить вложение;
* Загрузить и сразу открыть вложение;
* Открыть уже загруженное вложение;
* Открыть папку, куда загружен файл вложения;
* Изменить название и описание вложения;
* Скопировать вложение;
* Сохранить вложение в отдельный файл;
* Удалить вложение.
...
.. |button_c_identify| image:: _static/button_c_identify.png
   :width: 6mm
   :alt: курсор и синяя плашка с глобусом
