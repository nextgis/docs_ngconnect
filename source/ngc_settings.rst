...
**Включить версионирование объектов для загружаемых векторных слоёв** - это нужно для `одновременного редактирования с разных устройств <https://docs.nextgis.ru/docs_ngweb/source/version.html#vers-qgis>`_.
...
Автоматическую синхронизацию можно отключить `в свойствах слоя <https://docs.nextgis.ru/docs_ngconnect/source/resources.html#connect-data-sync>`_.
