...
Для этого выберите в панели Connect группу, внутри которой хотите создать слой. Затем в меню панели нажмите на стрелочку вниз рядом с изображением папки и выберите "Векторный слой NextGIS Web".
