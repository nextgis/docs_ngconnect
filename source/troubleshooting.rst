...
В разделе Аутентификация проверьте `данные пользователя <https://docs.nextgis.ru/docs_ngconnect/source/ngc_install.html#auth-config-create-pic>`_.
...
После этого нажмите **Проверка подключения**. Если все данные правильные, вы увидите зелёное сообщение об успешной проверке.
...
Если у вас возникает эта ошибка, вы пользуетесь старой версией NextGIS Connect. Обновите модуль до актуальной версии.
