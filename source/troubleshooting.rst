...
Слой, для которого включено версионирование, нельзя перезаписать новыми данными. Выключить версионирование можно `в настройках слоя в Веб ГИС <https://docs.nextgis.ru/docs_ngweb/source/layers_settings.html#create-vector-layer-vers-pic>`_.
